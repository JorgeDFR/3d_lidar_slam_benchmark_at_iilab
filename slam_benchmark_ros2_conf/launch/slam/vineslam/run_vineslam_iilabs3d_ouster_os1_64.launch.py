...
# colcon build --packages-select vineslam_ros --cmake-args -DLIDAR_TYPE=3
...
def generate_launch_description():
    ...
    params = os.path.join(dirname, 'vineslam_iilabs3d_ouster_os1_64.yaml')
